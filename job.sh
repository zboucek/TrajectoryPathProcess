...
#PBS -l select=1:ncpus=16:spec=8.0:mem=50gb:scratch_local=6gb
...
DATADIR="/storage/plzen1/home/$LOGNAME/disertace/pyparallel-2024-01-12/traj_plan"
...
singularity exec --bind $SCRATCHDIR:/data traj_container2.sif python3 /data/run_python_jobs.py --config "$DATADIR/configs/config_${i_world}_${i_config}.json"
